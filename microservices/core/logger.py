...
class Logger:
    ...
    be logged into a local file called yyyy_mm_dd_hh_ss_qhana.log laying in
    the log directory of the working directory.
    """
    ...
    log_to_file = True
    directory = "log"
    file_name = current_date_time.strftime("%Y_%m_%d_%H_%M_%S") + "_qhana"
    file_extension = "log"
    ...
    def create_directory() -> None:
        if not os.path.isdir(Logger.directory):
