...
class StatePreparationClustering(RotationalKMeansClusteringAlgorithm, QuantumAlgorithm):
    """
    An own implementation of a clustering algorithm based on state preparation procedures.
    """
    ...
    def _perform_rotational_clustering(self, centroid_angles, data_angles):
        ...
        while queue_not_empty:
            ...
            hits = self.calculate_even_qubits_0_hits(histogram)
